  ...
  return (
    <>
      ...
      <p className="mt-5 max-w-sm text-[15px] leading-relaxed text-white/70">
        I design and ship backend APIs for web platforms and mobile products —
        REST services in Python, Node.js, Go, and C# (.NET), with PostgreSQL
        data models, Redis caching, auth, real-time sync, and third-party
        integrations for ecommerce and B2B workloads.
      </p>
    </>
  );
}
